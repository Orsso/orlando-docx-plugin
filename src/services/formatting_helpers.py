...
Extracted from orlando_toolkit.core.converter.helpers module
...
def _process_paragraph_runs(p_element: ET.Element, paragraph: Paragraph, image_map: dict, color_rules: Dict[str, Any], *, exclude_images: bool = False) -> None:  # noqa: D401,E501
    ...
    # color_rules parameter now provided by caller
...
def process_paragraph_content_and_images(
    ...
    if conbody is None:
        _process_paragraph_runs(p_element, paragraph, image_map, color_rules, exclude_images=False)
        return
    ...
    _process_paragraph_runs(p_element, paragraph, image_map, color_rules, exclude_images=True)
