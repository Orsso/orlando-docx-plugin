"""DOCX Heading Filter Panel for UI Extensions.

Non-modal panel to manage heading style filters grouped by level.
Extracted from orlando_toolkit.ui.widgets.heading_filter_panel module
...
class HeadingFilterPanel(ttk.Frame):
    ...
    This is a DOCX plugin UI component that provides heading analysis
    and filtering functionality for Word documents.
