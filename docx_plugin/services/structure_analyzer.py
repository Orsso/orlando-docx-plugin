...
Extracted from orlando_toolkit.core.converter.structure_builder module
...
from ..utils.docx_parser import iter_block_items
from .formatting_helpers import get_heading_level
...
from ..utils.dita_builder import create_dita_table
    ...
    for node in nodes:
        ...
        if node.role == "section":
            ...
            generate_dita_from_structure(
                ...
                topichead, heading_counters, color_rules
            )
            ...
            generate_dita_from_structure(
                node.children, context, metadata, all_images_map_rid,
                topicref, heading_counters, color_rules
            )
    ...
    for block in content_blocks:
        if isinstance(block, Table):
            ...
            if is_image_para:
                ...
                process_paragraph_content_and_images(p_in_li, block, all_images_map_rid, None, color_rules)
                added_any = True
            else:
                current_list = None
                current_sl = None
                ...
                process_paragraph_content_and_images(p_el, block, all_images_map_rid, conbody, color_rules) 
                added_any = True
    return added_any